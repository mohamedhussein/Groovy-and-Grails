			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="applicationname" title="${message(code: 'application.applicationname.label', default: 'Applicationname')}" />
				...
				<g:each in="${applicationInstanceList}" status="i" var="applicationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${applicationInstance.id}">${fieldValue(bean: applicationInstance, field: "applicationname")}</g:link></td>
